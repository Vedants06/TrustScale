...
export function NodeCard({ node, history = [], onClick }: NodeCardProps) {
    ...
    return (
        <button
            ...
            onClick={onClick}
            className={`group rounded-lg border ${borderClass} bg-card p-6 text-left transition-all hover:border-primary/50 hover:bg-card/80 ${isQuarantined ? "opacity-50" : ""
                }`}
        >
            ...
            <div className="mt-3">
                <TrustSparkline data={history} color={sparklineColor} />
            </div>
